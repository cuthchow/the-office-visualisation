        ...
        function clusterByCharacter(){
            let keyppl = ['michael', 'jim', 'pam', 'dwight', 'jan', 'oscar']
            let charPos = d3.scaleOrdinal(['michael', 'jim', 'pam', 'dwight', 'jan', 'oscar'], [100, 300, 500, 700, 900, 1100])

            force
                .alpha([0.6])
                .force('forceX', d3.forceX(d => charPos(d.speaker)).strength([0.4]))
